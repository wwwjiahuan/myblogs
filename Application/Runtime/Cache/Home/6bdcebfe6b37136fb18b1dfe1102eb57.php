	...
	<body>
		<div id='wrapper'>
			...
			<div id='main'>
				<div class="container">
					<div id='picture'>
						<div id="pitHead"><img src="/before/blogs/Public/Images/pitHead.png" alt="图片1"></div>
						<div id="pitBody">
							<img class="one" src="/before/blogs/Public/Images/9.jpg" alt="图片2">
					...
					<div id='page'>
						...
						<div id="switch_body">
							<form action="/before/blogs/index.php/Home/Loginbackstage/doLogin" method="post" name="myForm" id="myForm">
								<p><span></span></p>
