					...
					<div id='content'>
						<div id='content_box'>
							<?php if(is_array($list)): foreach($list as $key=>$vo): ?><p class='title'><span>题目:</span><?php echo ($vo["title"]); ?></p>
								...
								<p class='function'>
									<a href="/xiangmu/Blogs/index.php/Home/Index/update?id=<?php echo ($vo["id"]); ?>" class='update'>修改</a>
									<a href="/xiangmu/Blogs/index.php/Home/Index/delete?id=<?php echo ($vo["id"]); ?>" class='delete'>删除</a>
								</p>
